...
from unet_def import UNet1,UNet
...
def create_Model(input_shape=constants.input_shape, encoder_type=constants.EncoderType.resnet50):
    ...
    if encoder_type == constants.EncoderType.resnet50:
        inputLayer, outputLayer, scaleLayers = resnet_def_copy.ResNet50(input_shape=constants.input_shape,include_top=False, create_encoder=True)
...
def create_Unet(input_shape=constants.input_shape):
    ...
    networkOutput = UNet1(f5, f4, f3, f2,f1, output_height=constants.input_shape[0], output_width=constants.input_shape[1])
